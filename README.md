...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastapi-mvc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15069&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastapi-mvc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastapi-mvc` can be installed with:

```
conda install fastapi-mvc
```

It is possible to list all of the versions of `fastapi-mvc` available on your platform with:
